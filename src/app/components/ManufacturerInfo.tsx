...
import {
  fetchAllMakesListByManufacturerId,
  fetchManufacturer
...
const ManufacturerInfo = (props: IProps & IActions): JSX.Element => {
   ...
   */
  const manufacturerQueryData = useQuery(
    ['company_cache', props.companyId],
   ...
   */
  const makesQueryData = useQuery(
    ['makes_cache', props.companyId],
    () => fetchAllMakesListByManufacturerId(props.companyId),
    {}
  )
  ...
  return (
    <div className={'manufacturer-info'}>
      ...
      {manufacturerQueryData.data?.Results[0] && (
        <div className={'panel'}>
          <ManufacturerCard
            company={mapExternalManufacturer(
              manufacturerQueryData.data?.Results[0]
            )}
          />
